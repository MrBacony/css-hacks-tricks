export const tricks: any[] = [
    {label: 'Center elements', stackblitz: 'https://stackblitz.com/edit/center-element?embed=1&file=index.html&hideNavigation=1&theme=light'},
    ...
    {label: 'State transitions', stackblitz: 'https://stackblitz.com/edit/state-transitions?embed=1&file=src/app/app.component.css&theme=light'},
    ...
    {label: ':target', stackblitz: 'https://stackblitz.com/edit/target-css?ctl=1&embed=1&file=styles.css&theme=light'},
